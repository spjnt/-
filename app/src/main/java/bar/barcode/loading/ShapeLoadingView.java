...
public class ShapeLoadingView extends View {
     ...
     * 用赛贝尔曲线画圆
     */
    private static final float mMagicNumber = 0.55228475f;//0.618
    ...
    private void init(Context context) {
        mTriangleColor = getColor(context, R.color.colorAccent);
        mCircleColor = getColor(context, R.color.login_button);
        mRectColor = getColor(context, R.color.eeee00);
        mPaint = new Paint();
